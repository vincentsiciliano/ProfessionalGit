 ...
 */
public class FlooringOrderServiceStubImpl implements FlooringOrderService {
    ...
    public FlooringOrderServiceStubImpl(FlooringOrderDao orderDao) {
    ...
    public boolean fileExists(String date){
        return orderDao.loadOrderFile("TESTOrders_" + date + ".csv");
    }
    ...
    public void toggleToProdMode(){
        ApplicationContext ctx = new ClassPathXmlApplicationContext("applicationContext.xml");
        this.orderDao = ctx.getBean("orderDaoStub", FlooringOrderDaoImpl.class);
    }
