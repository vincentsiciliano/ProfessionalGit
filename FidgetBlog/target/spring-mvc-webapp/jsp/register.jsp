            ...
            <div id="login-overlay" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="" method="POST" action="${pageContext.request.contextPath}/createuser"  name="newUserForm" id="newUserForm" modelAttribute="newUser">
                            ...
                            <div class="form-group">
                                ...
                                <div class="cols-sm-10">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                                        <input type="password" class="form-control" name="passWordConfirm" id="confirm_password"  placeholder="Confirm your Password" required/>
                                    </div>
                                </div>
                            </div>
